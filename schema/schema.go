...
type SettingsExperimentalFeatures struct {
	...
	// UseTreesitter description: The maximum number of files a repo can have to use case-insensitive fuzzy finding
	UseTreesitter *bool `json:"useTreesitter,omitempty"`
}
